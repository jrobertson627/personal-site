...
const links = [
  { label: 'GitHub', href: 'https://github.com/jrobertson627', Icon: GitHubIcon, external: true },
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/jessica-lani-robertson/',
    Icon: LinkedInIcon,
    external: true,
  },
  { label: 'Email', href: 'mailto:jessicarobertson627@gmail.com', Icon: MailIcon, external: false },
]
